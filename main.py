...
CUSTOM_WORD_PINYIN: dict[str, str] = {
    ...
    "赤蛮奇":	"chi man qi",
    "东方怪奇谈":	"dong fang guai qi tan",
    "珍奇的上海古牌":	"zhen qi de shang hai gu pai",
    "时刻旺盛的好奇心":	"shi ke wang sheng de hao qi xin",
    "非常非常神奇的道具们":	"fei chang fei chang shen qi de dao ju men",
    "合缘奇缘":	"he yuan qi yuan",
    "争奇斗艳的凭依华":	"zheng qi dou yan de ping yi hua",
    "奇数狙":	"ji shu ju",
    "奇李蝶蚕":	"qi li die can",
    "奇李蝶蚕·阿尔卡罗伊德":	"qi li die can",
    "奇门遁甲":	"qi men dun jia",
    "奇门":	"qi men",
    "猎奇剧团里的怪人":	"lie qi ju tuan li de guai ren",
    "摩西之奇迹":	"mo xi zhi qi ji",
    "灰色奇术":	"hui se qi shu",
    "空中落物的奇迹":	"kong zhong luo wu de qi ji",
    "奇美拉的噩梦":	"qi mei la de e meng",
    "奇迹五角星":	"qi ji wu jiao xing",
    "罗刹娑":	"luo sha suo",
}
